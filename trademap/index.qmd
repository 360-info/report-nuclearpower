...
transferArcs = new deck.MapboxLayer({
  ...
  // TODO - change colours based on commodity category
  // getSourceColor: d => [...defaultScheme[7], opacityScale(d.value_usd)],
  // getTargetColor: d => [...defaultScheme[3], opacityScale(d.value_usd)],
...
updates = transferArcs.setProps({
  data: categoryData,
  getSourceColor: d => [...deckColorScheme[7], opacityScale(d.value_usd)],
  getTargetColor: d => [...deckColorScheme[3], opacityScale(d.value_usd)]
})
```
